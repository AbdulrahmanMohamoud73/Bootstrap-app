...
function Landing (){
    ...
    return (
        <>
        <div className='grid grid-cols-2 grid-rows-2 items-center w-screen gap-x-16 pl-16 bg-gray-100 sticky h-5/6'>
            <div className='row-span-2'>
              <h1 className='font-bold font-Inter text-8xl my-10'> We Do Networks </h1>
              <h2 className='text-3xl font-Inter'>We provide comprehensive consultation services to help businesses <span className='text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-[#f5d547ff]'>optimize</span> their network infrastructure.</h2>
              <Link to='/About'>
